...
export const homepageText = `
  <p>Welcome to the 2023 Parma Dynasty Fantasty Football League Website.</p>
...
export const managers = [
    {
      ...
      "photo": "/managers/josh.jpeg", // square ratio recommended (no larger than 500x500)
      ...
      "rival": {
        name: "Anthony Meness", // Can be anything (usually your rival's name)
    ...
    },
   {
      ...
      "name": "Jake Bias",
      "tookOver": null, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Parma, OH", // (optional)
      "bio": "Multi-Time Champion",
      "photo": "/managers/img_5174.jpeg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2011, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "cle", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Paul Koehler", // Can be anything (usually your rival's name)
    ...
    },
   {
    ...
    },
    {
      ...
      "location": "Columbus, OH", // (optional)
      "bio": "Multi-Time Champion",
      "photo": "/managers/santana.jpeg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2011, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "cle", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Dynasty", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
